...
class XiaohongshuAccountSnapshot(Base):
    ...
    follower_count: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    following_count: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    liked_count: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    note_count: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
