...
class BrowserLoginState(Base):
    ...
    login_type: Mapped[str | None] = mapped_column(String(32), nullable=True)
    ...
    expire_risk_level: Mapped[str | None] = mapped_column(String(32), nullable=True)
    ...
    last_valid_time: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
