...
class DouyinLiveSnapshot(Base):
    ...
    online_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    total_viewer_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    new_viewer_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    like_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    new_like_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    comment_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    new_comment_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    share_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    gift_count: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    gift_amount: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
