...
class DouyinLiveRoom(Base):
    ...
    room_handle: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    account_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True, index=True)
    sec_account_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    ...
    last_live_status: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    last_live_start_time: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    last_live_end_time: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
