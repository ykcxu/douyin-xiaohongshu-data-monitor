...
live_monitor_service = scheduler_runtime.live_monitor_service
...
@router.get("/douyin/live/sidecar-frames")
def get_douyin_live_sidecar_frames(room_id: str, limit: int = 20) -> dict[str, object]:
    return live_monitor_service.debug_room_frames(room_id=room_id, limit=limit)
